...
#      end
  ...
  hiprg = RG.new(
    ...
    "hiprg@irtf.org",
    nil,
    "https://wiki.ietf.org/group/irtf/hiprg",
    [ gurtov, henderson ],
    nil,
    nil,
    "2012-7-24"
  ...
  iccrg = RG.new(
    ...
    "iccrg@irtf.org",
    nil,
    "https://wiki.ietf.org/group/irtf/ICCRG",
  ...
  icnrg = RG.new(
    ...
    "icnrg@irtf.org",
    nil,
    "https://wiki.ietf.org/group/irtf/icnrg",
    [ kutscher, oran ],
    nil,
    "2012-04-17",
    nil
  ...
  maprg = RG.new(
    ...
    "maprg@irtf.org",
    nil,
    "https://wiki.ietf.org/group/irtf/maprg",
    [ kuhlewind, plonka ],
    nil,
    "2016-08-22",
    nil
  ...
  nfvrg = RG.new(
    ...
    "nfvrg@irtf.org",
    nil,
    "https://wiki..ietf.org/group/irtf/nfvrg",
    [ lopez, ramki ],
    [ banks ],
    "2015-01-20",
    "2018-08-01"
  ...
  nmrg = RG.new(
    ...
    "nmrg@irtf.org",
    nil,
    "https://wiki.ietf.org/group/irtf/nmrg/WikiStart",
    [ ciavaglia, francois ],
    nil,
    "1999-03-14",
    nil
  ...
  p2prg = RG.new(
    ...
    "p2prg@irtf.org",
    nil,
    "https://wiki.ietf.org/group/irtf/PeerToPeerResearchGroup",
    [ hiltl, previdi ],
    nil,
    nil,
    "2013-02-25"
  ...
  rrg = RG.new(
    ...
    "rrg@irtf.org",
    nil,
    "https://wiki.ietf.org/group/irtf/RoutingResearchGroup",
    [ li ],
    nil,
    nil,
    "2014-06-10"
  ...
  sdnrg = RG.new(
    ...
    "sdn@irtf.org",
    nil,
    "https://wiki.ietf.org/group/irtf/sdnrg",
    [ king, shiomoto ],
    nil,
    "2013-01-14",
    "2017-01-06"
  ...
  tmrg = RG.new(
    ...
    "tmrg@irtf.org",
    nil,
    "https://wiki.ietf.org/group/irtf/tmrg",
    [ andrew ],
    nil,
    nil,
    "2011-09-26"
  ...
  vnrg = RG.new(
    ...
    "vnrg@irtf.org",
    nil,
    "https://wiki.ietf.org/group/irtf/vnrg",
    [ touch, stiemerling ],
    nil,
    nil,
    "2012-02-08"
